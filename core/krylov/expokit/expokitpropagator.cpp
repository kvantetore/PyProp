...
template<int Rank>
void ExpokitPropagator<Rank>::Setup(const typename Wavefunction<Rank>::Ptr psi)
{
...
template<int Rank>
void ExpokitPropagator<Rank>::AdvanceStep(object callback, typename Wavefunction<Rank>::Ptr psi, typename Wavefunction<Rank>::Ptr tempPsi, cplx dt, double t)
{
