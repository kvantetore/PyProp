/* ../zhexpv.f -- translated by f2c (version 20050501).
...
/* ----------------------------------------------------------------------| */
/* Subroutine */ int zhexpv(integer *n, integer *m, doublereal *t, 
...
/*  matvecdata: pointer to an arbitrary data sent to matvec as the first argument */
