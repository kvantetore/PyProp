subroutine ode ( f, ptr, neqn, y, t, tout, relerr, abserr, iflag, work, iwork )
...
!
!    PTR has been added in order for a C-pointer to be passed to the subroutine 
!    F, which is implemented in C++. This pointer takes care of neccessary
!    data passing between Pyprop and F.
!
!  Author:
!
...
!
!    Adapted for PYPROP 2007 (Raymond and Tore)
!
!  Reference:
!
!    Lawrence Shampine, Marilyn Gordon,
...
!
  ...
  call de ( f, ptr, neqn, y, t, tout, relerr, abserr, iflag, work(iyy), &
...
subroutine de ( f, ptr, neqn, y, t, tout, relerr, abserr, iflag, yy, wt, p, yp, &
...
!
    ...
    call step ( x, yy, f, ptr, neqn, h, eps, wt, start, &
...
subroutine step ( x, y, f, ptr, neqn, h, eps, wt, start, hold, k, kold, crash, &
