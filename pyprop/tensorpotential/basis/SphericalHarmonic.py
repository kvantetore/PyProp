...
class GeometryInfoSphericalHarmonic(GeometryInfoBase):
	"""
...
class GeometryInfoSphericalHarmonicDistributed(GeometryInfoDistributedBase):
	"""
...
class BasisfunctionSphericalHarmonic(BasisfunctionBase):
	"""
